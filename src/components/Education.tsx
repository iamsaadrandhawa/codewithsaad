          ...
          {education.map((edu, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className={`inline-flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-r ${edu.gradient} shadow-lg mb-4 transform group-hover:scale-110 transition-transform duration-300`}>
                  {edu.icon}
                </div>
                ...
                {/* Status Badge */}
                <div className="mt-6 inline-flex items-center px-2 py-1 rounded-full bg-green-500/20 border border-green-500/30">
